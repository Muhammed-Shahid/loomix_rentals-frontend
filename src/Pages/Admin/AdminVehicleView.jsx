        ...
        <Content style={{ background: "white" }}>
          ...
          >
                ...
                <Sider theme="light" style={{ bottom: 0, top: 0, left: 0 }}>
                  ...
                  >
                    ...
                    <Menu.Item
                      ...
                      onClick={() => mainImageHandler(vehicleDetails.rc_book)}
                    >
                      <Image
                        style={{
                          borderRadius: 20,
                        ...
                        preview={false}
                        src={`${base_url + vehicleDetails.rc_book}`}
                      />
                    </Menu.Item>
                    ...
                    <Menu.Item
                      ...
                      onClick={() =>
                        mainImageHandler(vehicleDetails.pollution_certificate)
                      }
                    >
                      <Image
                        style={{
                        ...
                        preview={false}
                        src={`${
                          base_url + vehicleDetails.pollution_certificate
                        }`}
                      />
                    </Menu.Item>
                  </Menu>
            ...
            >
              ...
              <Row>
           <VerifyVehicle vehicle_id={vehicleDetails.id} />
              </Row>
            </Col>
          </Row>
        </Content>
